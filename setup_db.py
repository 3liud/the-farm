...
def create_database(db_name, user='postgres', password='yourpassword', host='localhost', port='5432'):
...
def create_tables():
    conn = psycopg2.connect(dbname='kilimodata', user='postgres', password='yourpassword', host='localhost')
    cursor = conn.cursor()
